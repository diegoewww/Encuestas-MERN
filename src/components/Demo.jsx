      ...
      <div className="p-3">
        ...
        <div className="flex flex-column w-75 mr-auto mx-auto">
          <div className="py-3 w-100 mb-4 shadow-lg hover-zoom px-2  rounded bg-white">
            <label role="button" htmlFor="opcion1" className="flex align-items-center">
              <input
                type="radio"
                id="opcion1"
                name="opcion"
          ...
          <div className="py-3 w-100 mb-4 shadow-lg hover-zoom px-2  rounded bg-white">
            <label htmlFor="opcion2" role="button" className="flex align-items-center ">
              <input
                type="radio"
                id="opcion2"
                name="opcion"
          ...
          <div className="py-3 w-100 mb-4 shadow-lg hover-zoom px-2  rounded bg-white">
          <label htmlFor="opcion3" role="button"className="flex align-items-center ">
              <input
                type="radio"
                id="opcion3"
                name="opcion"
          ...
          <div className="py-3 w-100 mb-4 shadow-lg hover-zoom px-2  rounded bg-white">
          <label htmlFor="opcion4" role="button" className="flex align-items-center ">
              <input
                type="radio"
                id="opcion4"
                name="opcion"
